...
void publishState(void)
{
	...
	if (pub_imu.getNumSubscribers() > 0)
	{
		...
		imu_msg.header.frame_id = "openni_camera";
		...
		imu_msg.linear_acceleration_covariance[0] = -1; // indicates not provided
		imu_msg.angular_velocity_covariance[0] = imu_msg.angular_velocity_covariance[4] = 1e6;
			imu_msg.angular_velocity_covariance[8] = 1e-6;
		imu_msg.orientation_covariance[0] = imu_msg.orientation_covariance[4] = 1e6;
