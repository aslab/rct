/* Auto-generated by genmsg_cpp for file /usr/local/ros_aslab_electric/higgs_autonomous_navigation_electric/higgs_navigation/msg/OdomDriverActionResult.msg */
...
{
template<class ContainerAllocator> struct IsMessage< ::higgs_navigation::OdomDriverActionResult_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::higgs_navigation::OdomDriverActionResult_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
