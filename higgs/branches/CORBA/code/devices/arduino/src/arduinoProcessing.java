 ...
 *
 *         <p>
 *         Direct communication with the Arduino board.
 *         </p>
 */
public class arduinoProcessing implements SerialPortEventListener {
	...
	/**
	 * Set the number of batteries used
	 */
	static int n_bat;
	...
	public void serialEvent(SerialPortEvent arg0) {
		try
		{
			...
			if (orden.tipo_orden() == 0) {
				...
				// System.out.println("DEBUG Point 19");
				if (orden.orden_enviada() == false) {
					...
					// System.out.println("DEBUG Point 26");
				}
		...
		{
			// System.out.println("DEBUG Point 27");
			System.err.println("ERROR: " + e);
			e.printStackTrace(System.out);
			System.exit(1);
		}

		// System.out.println("DEBUG Point 28");
	}
