 ...
 *
 * \brief CORBA servant implementation for the GPS.
 *
 * The GPS box must be configured.
 * Once the connection is established, it is kept alive forever and reports unknown
 * state if connection is lost.
 */
#include "gps.h"
#include <iostream>
#include <sstream>
