...
CMAKE_SOURCE_DIR = /usr/local/ros_aslab/higgs_map_building

# The top-level build directory on which CMake was run.
CMAKE_BINARY_DIR = /usr/local/ros_aslab/higgs_map_building/build

# Utility rule file for clean-test-results.

CMakeFiles/clean-test-results:
	if ! rm -rf /root/.ros/test_results/higgs_map_building; then echo WARNING:\ failed\ to\ remove\ test-results\ directory ; fi
...
CMakeFiles/clean-test-results.dir/depend:
	cd /usr/local/ros_aslab/higgs_map_building/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /usr/local/ros_aslab/higgs_map_building /usr/local/ros_aslab/higgs_map_building /usr/local/ros_aslab/higgs_map_building/build /usr/local/ros_aslab/higgs_map_building/build /usr/local/ros_aslab/higgs_map_building/build/CMakeFiles/clean-test-results.dir/DependInfo.cmake --color=$(COLOR)
